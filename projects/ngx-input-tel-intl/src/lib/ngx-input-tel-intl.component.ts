...
@Component({
    ...
    styleUrls: [ 'ngx-input-tel-intl.component.css', './flags/css/input-tel-intl.css' ],
    providers: [
        {
...
export class NgxInputTelIntlComponent implements OnChanges {
    ...
    protected fetchCountryData(): void {
        ...
        this.countries$ = this.searchQuery$.asObservable().pipe(
            map(searchQuery =>
                this.countries.filter(c => LocalPhoneUtils.isCountryMatching(c, searchQuery, this.searchCountryField) || c.isFavorite))
        );
